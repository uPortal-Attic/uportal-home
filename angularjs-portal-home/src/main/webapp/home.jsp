...
<noscript>
  ...
  <script type="text/javascript" src="js/layout/widget-controllers.js"></script>
  <script type="text/javascript" src="js/layout/layout-controller.js"></script>
  <script type="text/javascript" src="js/layout/layout-services.js"></script>
  <script type="text/javascript" src="js/layout/layout-directives.js"></script>
  <script type="text/javascript" src="js/controllers.js"></script>
  <script type="text/javascript" src="js/services.js"></script>
  <script type="text/javascript" src="js/notifications/notification-controllers.js"></script>
  <script type="text/javascript" src="js/notifications/notification-directives.js"></script>
  <script type="text/javascript" src="js/app-config.js"></script>
  <script type="text/javascript" src="js/directives.js"></script>
  <script type="text/javascript" src="js/filters.js"></script>
  <script type="text/javascript" src="js/marketplace/marketplace-service.js"></script>
  <script type="text/javascript" src="js/marketplace/marketplace-controller.js"></script>
  <script type="text/javascript" src="js/marketplace/marketplace-directive.js"></script>
